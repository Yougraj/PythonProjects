...
# Step 1: Package the app with PyInstaller
...
# Step 2: Move the executable to the system path
...
# Step 3: Move the icon to a secure location
...
# Step 5: Clean up PyInstaller build directories
